...
{
  let validTypes = ["int", "string", "date", "boolean", "float"]
  for (let model of models) {
    ...
    for (let attr of attrs) {
      ...
      if (attr.meta == null)
        return `Invalid metadata (${mName}.${attr.name})<br/>TIP: Use format:<br/>name:value<br/>name:value`
      if (attr.type == "string") {
